...
class TestRegisterPages(unittest.TestCase):
    def test_register_page_1(self):
        self.assertEqual(register("http://suninjuly.github.io/registration1.html"),
                         RESULT_STR, "Failed result of registration")

    def test_register_page_2(self):
        self.assertEqual(register("http://suninjuly.github.io/registration2.html"),
                         RESULT_STR, "Failed result of registration")
